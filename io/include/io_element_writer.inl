                                                          ...
                                                          const data_classifier_t *occurrence )
{
    ...
    return (*(  (*((*this_).interface)).start_diagramelement  )) ( (*this_).objectdata, diagramelement_ptr, host, occurrence );
}
                                                             ...
                                                             const data_classifier_t *occurrence )
{
    ...
    return (*(  (*((*this_).interface)).assemble_diagramelement  )) ( (*this_).objectdata, diagramelement_ptr, host, occurrence );
}
                                                        ...
                                                        const data_classifier_t *occurrence )
{
    ...
    return (*(  (*((*this_).interface)).end_diagramelement  )) ( (*this_).objectdata, diagramelement_ptr, host, occurrence );
}
