...
static void testCrossLanguage(void) {
...
#ifdef __cplusplus
    TEST_EXPECT( NULL=="testCrossLanguage was run in c++ linkage environment." );
#endif
    ...
    TEST_EXPECT_EQUAL_INT( 1, success );
}
...
static void testSplitIn2(void) {
    ...
    /* test good case */
    {
        ...
        TEST_EXPECT_EQUAL_INT( UTF8ERROR_SUCCESS, tuple.error );
        equals = memcmp( "H\0\xE2\x82\xAC", dynTestArr10, 6 );
        TEST_EXPECT_EQUAL_INT( 0, equals );
        TEST_EXPECT( &(dynTestArr10[0]) == tuple.first );
        TEST_EXPECT( &(dynTestArr10[2]) == tuple.second );

        /* check buffer boundaries */
        TEST_EXPECT_EQUAL_INT( ' ', dynTestArr10_withBorders[0] );
        TEST_EXPECT_EQUAL_INT( ' ', dynTestArr10_withBorders[7] );
    }
    ...
    /* test good case, empty first string */
    {
        ...
        TEST_EXPECT_EQUAL_INT( 0, equals );
        TEST_EXPECT( &(dynTestArr11[0]) == tuple.first );
        TEST_EXPECT( &(dynTestArr11[1]) == tuple.second );

        /* check buffer boundaries */
        TEST_EXPECT_EQUAL_INT( ' ', dynTestArr11_withBorders[0] );
        TEST_EXPECT_EQUAL_INT( ' ', dynTestArr11_withBorders[7] );
    }
    ...
    /* test good case, empty second string */
    {
        ...
        TEST_EXPECT_EQUAL_INT( 0, equals );
        TEST_EXPECT( &(dynTestArr12[0]) == tuple.first );
        TEST_EXPECT( &(dynTestArr12[5]) == tuple.second );

        /* check buffer boundaries */
        TEST_EXPECT_EQUAL_INT( ' ', dynTestArr12_withBorders[0] );
        TEST_EXPECT_EQUAL_INT( ' ', dynTestArr12_withBorders[7] );
    }
    ...
    /* test good case, both strings empty */
    {
        ...
        TEST_EXPECT_EQUAL_INT( 0, equals );
        TEST_EXPECT( &(dynTestArr13[0]) == tuple.first );
        TEST_EXPECT( &(dynTestArr13[1]) == tuple.second );

        /* check buffer boundaries */
        TEST_EXPECT_EQUAL_INT( ' ', dynTestArr13_withBorders[0] );
        TEST_EXPECT_EQUAL_INT( ' ', dynTestArr13_withBorders[7] );
    }
    ...
    /* test truncation of second string only */
    {
        ...
        TEST_EXPECT_EQUAL_INT( UTF8ERROR_TRUNCATED, tuple.error );
        equals = memcmp( "H\0e\0\0", dynTestArr1, 6 );
        TEST_EXPECT_EQUAL_INT( 0, equals );
        TEST_EXPECT( &(dynTestArr1[0]) == tuple.first );
        TEST_EXPECT( &(dynTestArr1[2]) == tuple.second );

        /* check buffer boundaries */
        TEST_EXPECT_EQUAL_INT( ' ', dynTestArr1_withBorders[0] );
        TEST_EXPECT_EQUAL_INT( ' ', dynTestArr1_withBorders[7] );
    }
    ...
    /* test truncation of both strings */
    {
        ...
        TEST_EXPECT_EQUAL_INT( 0, equals );
        TEST_EXPECT( &(dynTestArr2[0]) == tuple.first );
        TEST_EXPECT( &(dynTestArr2[5]) == tuple.second );

        /* check buffer boundaries */
        TEST_EXPECT_EQUAL_INT( ' ', dynTestArr2_withBorders[0] );
        TEST_EXPECT_EQUAL_INT( ' ', dynTestArr2_withBorders[7] );
    }
    ...
    /* test for illegal parameters: -1 */
    {
        ...
        TEST_EXPECT_EQUAL_INT( UTF8ERROR_OUT_OF_RANGE, tuple.error );
        equals = memcmp( "He\xE2\x82\xAC", dynTestArr3, 6 );
        TEST_EXPECT_EQUAL_INT( 0, equals );
        TEST_EXPECT( &(dynTestArr3[0]) == tuple.first );
        TEST_EXPECT( &(dynTestArr3[5]) == tuple.second );

        /* check buffer boundaries */
        TEST_EXPECT_EQUAL_INT( ' ', dynTestArr3_withBorders[0] );
        TEST_EXPECT_EQUAL_INT( ' ', dynTestArr3_withBorders[7] );
    }
    ...
    /* test for illegal parameters: 5 */
    {
        ...
        TEST_EXPECT_EQUAL_INT( 0, equals );
        TEST_EXPECT( &(dynTestArr4[0]) == tuple.first );
        TEST_EXPECT( &(dynTestArr4[4]) == tuple.second );

        /* check buffer boundaries */
        TEST_EXPECT_EQUAL_INT( ' ', dynTestArr4_withBorders[0] );
        TEST_EXPECT_EQUAL_INT( ' ', dynTestArr4_withBorders[7] );
    }
...
static void testSplitIn3(void) {
    ...
    /* test standard case */
    {
        ...
        TEST_EXPECT_EQUAL_INT( 0, equals );
        TEST_EXPECT( &(dynTestArr1[0]) == tuple.first );
        TEST_EXPECT( &(dynTestArr1[1]) == tuple.second );
        TEST_EXPECT( &(dynTestArr1[3]) == tuple.third );
    ...
    /* test full buffer case, no truncation */
    {
        ...
        TEST_EXPECT( &(dynTestArr1[0]) == tuple.first );
        TEST_EXPECT( &(dynTestArr1[1]) == tuple.second );
        TEST_EXPECT( &(dynTestArr1[2]) == tuple.third );
    ...
    /* test full buffer case, no truncation */
    {
        ...
        TEST_EXPECT_EQUAL_INT( 0, equals );
        TEST_EXPECT( &(dynTestArr1[0]) == tuple.first );
        TEST_EXPECT( &(dynTestArr1[4]) == tuple.second );
        TEST_EXPECT( &(dynTestArr1[5]) == tuple.third );
    ...
    /* test min buffer case */
    {
        ...
        TEST_EXPECT_EQUAL_INT( 0, equals );
        TEST_EXPECT( &(dynTestArr3[0]) == tuple.first );
        TEST_EXPECT( &(dynTestArr3[1]) == tuple.second );
        TEST_EXPECT( &(dynTestArr3[2]) == tuple.third );

        /* check buffer boundaries */
        TEST_EXPECT_EQUAL_INT( ' ', dynTestArr3_withBorders[0] );
        TEST_EXPECT_EQUAL_INT( ' ', dynTestArr3_withBorders[4] );
    }
    ...
    /* test small buffer case */
    {
        ...
        TEST_EXPECT_EQUAL_INT( 0, equals );
        TEST_EXPECT( &(dynTestArr4[0]) == tuple.first );
        TEST_EXPECT( &(dynTestArr4[1]) == tuple.second );
        TEST_EXPECT( &(dynTestArr4[1]) == tuple.third );

        /* check buffer boundaries */
        TEST_EXPECT_EQUAL_INT( ' ', dynTestArr4_withBorders[0] );
        TEST_EXPECT_EQUAL_INT( ' ', dynTestArr4_withBorders[3] );
    }
    ...
    /* test full buffer case, truncate 3rd */
    {
        ...
        TEST_EXPECT_EQUAL_INT( 0, equals );
        TEST_EXPECT( &(dynTestArr1[0]) == tuple.first );
        TEST_EXPECT( &(dynTestArr1[5]) == tuple.second );
        TEST_EXPECT( &(dynTestArr1[5]) == tuple.third );
    ...
    /* test out of range case */
    {
        ...
        TEST_EXPECT_EQUAL_INT( 0, equals );
        TEST_EXPECT( &(dynTestArr1[0]) == tuple.first );
        TEST_EXPECT( &(dynTestArr1[3]) == tuple.second );
        TEST_EXPECT( &(dynTestArr1[3]) == tuple.third );
    ...
    /* test truncate third string only case */
    {
        ...
        TEST_EXPECT( &(dynTestArr1[0]) == tuple.first );
        TEST_EXPECT( &(dynTestArr1[2]) == tuple.second );
        TEST_EXPECT( &(dynTestArr1[4]) == tuple.third );
    ...
    /* test for illegal parameters: -1 */
    {
        ...
        TEST_EXPECT( &(dynTestArr4[0]) == tuple.first );
        TEST_EXPECT( &(dynTestArr4[4]) == tuple.second );
        TEST_EXPECT( &(dynTestArr4[4]) == tuple.third );
...
static void testSplitIn4(void) {
    ...
    /* test standard case */
    {
        ...
        TEST_EXPECT( &(dynTestArr1[1]) == tuple.second );
        TEST_EXPECT( &(dynTestArr1[3]) == tuple.third );
        TEST_EXPECT( &(dynTestArr1[7]) == tuple.fourth );

        /* check buffer boundaries */
        TEST_EXPECT_EQUAL_INT( ' ', dynTestArr1_withBorders[0] );
        TEST_EXPECT_EQUAL_INT( ' ', dynTestArr1_withBorders[11] );
    }
    ...
    /* test truncation of 3rd and 4th */
    {
        ...
        TEST_EXPECT( &(dynTestArr1[0]) == tuple.first );
        TEST_EXPECT( &(dynTestArr1[2]) == tuple.second );
        TEST_EXPECT( &(dynTestArr1[6]) == tuple.third );
        TEST_EXPECT( &(dynTestArr1[9]) == tuple.fourth );
    ...
    /* test truncation of 3rd */
    {
        ...
        TEST_EXPECT( &(dynTestArr1[0]) == tuple.first );
        TEST_EXPECT( &(dynTestArr1[5]) == tuple.second );
        TEST_EXPECT( &(dynTestArr1[9]) == tuple.third );
        TEST_EXPECT( &(dynTestArr1[9]) == tuple.fourth );
    ...
    /* test for illegal parameters: 5 */
    {
        ...
        TEST_EXPECT( &(dynTestArr4[4]) == tuple.second );
        TEST_EXPECT( &(dynTestArr4[4]) == tuple.third );
        TEST_EXPECT( &(dynTestArr4[4]) == tuple.fourth );
...
static void testSplitIn5(void) {
    ...
    /* test standard case */
    {
        ...
        TEST_EXPECT( &(dynTestArr1[3]) == tuple.third );
        TEST_EXPECT( &(dynTestArr1[7]) == tuple.fourth );
        TEST_EXPECT( &(dynTestArr1[8]) == tuple.fifth );
    ...
    /* test truncation of 4th, 4th has own terminating zero, and 5th */
    {
        ...
        TEST_EXPECT( &(dynTestArr1[2]) == tuple.second );
        TEST_EXPECT( &(dynTestArr1[6]) == tuple.third );
        TEST_EXPECT( &(dynTestArr1[8]) == tuple.fourth );
        TEST_EXPECT( &(dynTestArr1[9]) == tuple.fifth );
    ...
    /* test truncation of 4th, 4th has no own terminating zero anymore, and 5th */
    {
        ...
        TEST_EXPECT( &(dynTestArr1[0]) == tuple.first );
        TEST_EXPECT( &(dynTestArr1[4]) == tuple.second );
        TEST_EXPECT( &(dynTestArr1[8]) == tuple.third );
        TEST_EXPECT( &(dynTestArr1[9]) == tuple.fourth );
        TEST_EXPECT( &(dynTestArr1[9]) == tuple.fifth );
    ...
    /* test truncation of 3rd, 4th and 5th */
    {
        ...
        TEST_EXPECT_EQUAL_INT( 0, equals );
        TEST_EXPECT( &(dynTestArr1[0]) == tuple.first );
        TEST_EXPECT( &(dynTestArr1[6]) == tuple.second );
        TEST_EXPECT( &(dynTestArr1[9]) == tuple.third );
        TEST_EXPECT( &(dynTestArr1[9]) == tuple.fourth );
        TEST_EXPECT( &(dynTestArr1[9]) == tuple.fifth );
    ...
    /* test for illegal parameters: wrong order */
    {
        ...
        TEST_EXPECT( &(dynTestArr4[4]) == tuple.third );
        TEST_EXPECT( &(dynTestArr4[4]) == tuple.fourth );
        TEST_EXPECT( &(dynTestArr4[4]) == tuple.fifth );
...
static void testJoin(void) {
    ...
    /* test one join, one string-end and some terminating nonsense */
    {
        ...
        /* check buffer boundaries */
        TEST_EXPECT_EQUAL_INT( ' ', dynTestArr1_withBorders[0] );
        TEST_EXPECT_EQUAL_INT( ' ', dynTestArr1_withBorders[10] );
    }
    ...
    /* test two string-ends right at start and some terminating nonsense */
    {
        ...
        /* check buffer boundaries */
        TEST_EXPECT_EQUAL_INT( ' ', dynTestArr2_withBorders[0] );
        TEST_EXPECT_EQUAL_INT( ' ', dynTestArr2_withBorders[10] );
    }
    ...
    /* test one single full string without trailing data */
    {
        ...
        /* check buffer boundaries */
        TEST_EXPECT_EQUAL_INT( ' ', dynTestArr3_withBorders[0] );
        TEST_EXPECT_EQUAL_INT( ' ', dynTestArr3_withBorders[10] );
    }
    ...
    /* test 5 substrings without trailing data */
    {
        ...
        /* check buffer boundaries */
        TEST_EXPECT_EQUAL_INT( ' ', dynTestArr4_withBorders[0] );
        TEST_EXPECT_EQUAL_INT( ' ', dynTestArr4_withBorders[10] );
    }
}
...
static void testSplitAndJoin(void) {
    /* test standard case */
    {
        ...
        TEST_EXPECT_EQUAL_INT( UTF8ERROR_SUCCESS, tuple.error );
        TEST_EXPECT_EQUAL_STRING( "He", tuple.first );
        TEST_EXPECT_EQUAL_STRING( "\xE2\x82\xACllo", tuple.second );
        utf8stringbuf_join( dynTestBuf1 );
        TEST_EXPECT_EQUAL_STRING( "He\xE2\x82\xACllo", dynTestBuf1.buf );
    }
    /* test trailing non-zeroes */
    {
        ...
        TEST_EXPECT_EQUAL_INT( UTF8ERROR_SUCCESS, tuple2.error );
        TEST_EXPECT_EQUAL_STRING( "He", tuple2.first );
        TEST_EXPECT_EQUAL_STRING( "llo", tuple2.second );
        utf8stringbuf_join( dynTestBuf2 );
        TEST_EXPECT_EQUAL_STRING( "Hello", dynTestBuf2.buf );
    }
    /* test truncation */
    {
        ...
        TEST_EXPECT_EQUAL_INT( UTF8ERROR_TRUNCATED, tuple3.error );
        TEST_EXPECT_EQUAL_STRING( "He", tuple3.first );
        TEST_EXPECT_EQUAL_STRING( "llo ", tuple3.second );
        utf8stringbuf_join( dynTestBuf3 );
