 ...
 *  e.g.
 *  all U8_ERROR_USE_* errors could be shown to the user,
 *  all U8_ERROR_LOGIC_* errors could terminate the program,
 *  all U8_ERROR_OP_ENV_RUN errors could be retried at a later point in time
 */
enum u8_error_enum {

    U8_ERROR_NONE          = 0x00000000,  /*!< success */

    U8_ERROR_LOGIC_ANOMALY =-2147483648,  /*!< CAUSE:    Unexpected result of function */
                                          /*!< REACTION: TRACE, handle by caller */
                                          /*!< EXAMPLE:  key in set not found */
    U8_ERROR_LOGIC_STATE   = 0x40000000,  /*!< CAUSE:    Wrong internal state: */
    ...
    U8_ERROR_LOGIC_PARAMS  = 0x20000000,  /*!< CAUSE:    Illegal parameter: */
                                          /*!<           The input from a caller of the _own_ software subsystem is illegal. */
                                          /*!< REACTION: TERMINATE, notify developer */
                                          /*!< EXAMPLE:  Parameter out of range */
    U8_ERROR_LOGIC_CORRUPT = 0x10000000,  /*!< CAUSE:    Internal data/program corruption: */
    ...
    U8_ERROR_OP_ENV_START  = 0x08000000,  /*!< CAUSE:    Unexpected environment at system start: */
                                          /*!< REACTION: CANCEL START, notify operator */
                                          /*!< EXAMPLE:  Not enough memory available; */
                                          /*!<           network unreachable. */
    U8_ERROR_OP_ENV_RUN    = 0x04000000,  /*!< CAUSE:    Unexpected environment: */
    ...
    U8_ERROR_OP_TIMEOUT    = 0x02000000,  /*!< CAUSE:    Missing response/reaction from communication partner */
                                          /*!< REACTION: CONTINUE, notify operator */
                                          /*!< EXAMPLE:  A remote prodedure call times out; */
                                          /*!<           A callback is not called; */
    U8_ERROR_OP_SYS_ACCESS = 0x01000000,  /*!< CAUSE:    The system has not sufficient access rights to access resources */
                                          /*!< REACTION: CONTINUE, notify operator */
                                          /*!< EXAMPLE:  Mounting a disk is not permitted; */
                                          /*!<           Accessing network is prohibited. */
    U8_ERROR_USE_MODE      = 0x00800000,  /*!< CAUSE:    Wrong mode: */
                                          /*!<           The own software module is not in the right state */
                                          /*!<           for the requested operation. */
                                          /*!< REACTION: CONTINUE, notify user */
                                          /*!< EXAMPLE:  database not open; */
                                          /*!<           Wrong diagram type to add an element. */
    U8_ERROR_USE_INPUT     = 0x00400000,  /*!< CAUSE:    Unexpected input:   */
    ...
    U8_ERROR_USE_OUTPUT    = 0x00200000,  /*!< CAUSE:    Output is limited or not possible */
                                          /*!< REACTION: CONTINUE, notify user */
                                          /*!< EXAMPLE:  A disk selected by the user is full. */
    U8_ERROR_USE_ACCESS    = 0x00100000,  /*!< CAUSE:    The user has not sufficient access rights */
                                          /*!<           for the requested operation. */
                                          /*!< REACTION: CONTINUE, notify user */
