...
rm -fr architecture CMakeLists.txt ctrl data doxygen_build gui installation_linux io LICENSE.txt main pencil README.md ChangeLog test_fw todo.txt trace tslog universal user_doc utf8stringbuf
