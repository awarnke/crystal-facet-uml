...
void gui_resource_selector_init ( gui_resource_selector_t *this_, gui_resources_t *resources )
{
    ...
    (*this_).diagram_types_start = idx;
    {
        ...
        GdkPixbuf *icon_diag_list = gui_resources_get_type_diag_list ( (*this_).resources );
        gui_type_resource_init_diagram( current, DATA_DIAGRAM_TYPE_LIST, "List Diagram", icon_diag_list );
        current = &((*this_).type_name_icon_list[idx]); idx++;
        GdkPixbuf *icon_diag_box = gui_resources_get_type_diag_box ( (*this_).resources );
        gui_type_resource_init_diagram( current, DATA_DIAGRAM_TYPE_BOX_DIAGRAM, "Box Diagram", icon_diag_box );

        current = &((*this_).type_name_icon_list[idx]); idx++;
        GdkPixbuf *icon_diag_block = gui_resources_get_type_diag_block ( (*this_).resources );
        ...
        current = &((*this_).type_name_icon_list[idx]); idx++;
        GdkPixbuf *icon_diag_internal = gui_resources_get_type_diag_internal ( (*this_).resources );
        ...
        current = &((*this_).type_name_icon_list[idx]); idx++;
        GdkPixbuf *icon_diag_parametric = gui_resources_get_type_diag_parametric ( (*this_).resources );
        ...
        current = &((*this_).type_name_icon_list[idx]); idx++;
        GdkPixbuf *icon_diag_deployment = gui_resources_get_type_diag_deployment ( (*this_).resources );
        ...
        current = &((*this_).type_name_icon_list[idx]); idx++;
        GdkPixbuf *icon_diag_component = gui_resources_get_type_diag_component ( (*this_).resources );
        gui_type_resource_init_diagram( current, DATA_DIAGRAM_TYPE_UML_COMPONENT_DIAGRAM, "Component Diagram (UML)", icon_diag_component );
        current = &((*this_).type_name_icon_list[idx]); idx++;
        GdkPixbuf *icon_diag_composite = gui_resources_get_type_diag_composite ( (*this_).resources );
        ...
        /* behavioral diagrams: */
        current = &((*this_).type_name_icon_list[idx]); idx++;
        GdkPixbuf *icon_diag_usecase = gui_resources_get_type_diag_usecase ( (*this_).resources );
        ...
        current = &((*this_).type_name_icon_list[idx]); idx++;
        GdkPixbuf *icon_diag_overview = gui_resources_get_type_diag_overview ( (*this_).resources );
        ...
        current = &((*this_).type_name_icon_list[idx]); idx++;
        GdkPixbuf *icon_diag_activity = gui_resources_get_type_diag_activity ( (*this_).resources );
        ...
        current = &((*this_).type_name_icon_list[idx]); idx++;
        GdkPixbuf *icon_diag_state  = gui_resources_get_type_diag_state ( (*this_).resources );
        ...
        current = &((*this_).type_name_icon_list[idx]); idx++;
        GdkPixbuf *icon_diag_communication = gui_resources_get_type_diag_communication ( (*this_).resources );
        ...
        current = &((*this_).type_name_icon_list[idx]); idx++;
        GdkPixbuf *icon_diag_sequence = gui_resources_get_type_diag_sequence ( (*this_).resources );
        ...
        current = &((*this_).type_name_icon_list[idx]); idx++;
        GdkPixbuf *icon_diag_timing = gui_resources_get_type_diag_timing ( (*this_).resources );
    ...
    (*this_).classifier_types_start = idx;
    {
        ...
        current = &((*this_).type_name_icon_list[idx]); idx++;
        GdkPixbuf *icon_clas_requirement = gui_resources_get_type_clas_requirement( (*this_).resources );
        gui_type_resource_init_classifier( current, DATA_CLASSIFIER_TYPE_REQUIREMENT, "Requirement", icon_clas_requirement );
        /* behavioral classifiers: */
        current = &((*this_).type_name_icon_list[idx]); idx++;
        GdkPixbuf *icon_clas_actor = gui_resources_get_type_clas_actor( (*this_).resources );
        gui_type_resource_init_classifier( current, DATA_CLASSIFIER_TYPE_ACTOR, "Actor", icon_clas_actor );
        current = &((*this_).type_name_icon_list[idx]); idx++;
        GdkPixbuf *icon_clas_usecase = gui_resources_get_type_clas_usecase( (*this_).resources );
        ...
        current = &((*this_).type_name_icon_list[idx]); idx++;
        GdkPixbuf *icon_clas_deephistory = gui_resources_get_type_clas_deephistory( (*this_).resources );
    ...
    (*this_).relationship_types_start = idx;
    {
        ...
        assert( idx < GUI_RESOURCE_SELECTOR_MAX_TYPES );
        current = &((*this_).type_name_icon_list[idx]); idx++;
        GdkPixbuf *icon_rel_return = gui_resources_get_type_rel_return( (*this_).resources );
