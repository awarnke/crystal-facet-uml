...
void gui_sketch_card_private_draw_element_space( const gui_sketch_card_t *this_, const layout_subelement_id_t *subelement, cairo_t *cr )
{
    const layout_visible_set_t *const layout = pencil_diagram_maker_get_layout_data_const( &((*this_).painter) );
    ...
    if ( data_id_equals( &search_id, &diag_id ) )
    {
        switch ( kind )
        {
            case LAYOUT_SUBELEMENT_KIND_LABEL:
            {
                ...
                gui_sketch_card_private_draw_rect( this_, &highlight, cr );
            }
            break;
            ...
            case LAYOUT_SUBELEMENT_KIND_OUTLINE:
            {
                ...
                gui_sketch_card_private_draw_border( this_, &highlight, &empty_space, cr );
            }
            break;
            ...
            switch ( kind )
            {
                ...
                case LAYOUT_SUBELEMENT_KIND_OUTLINE:
                {
                        ...
                        = layout_relationship_get_shape_const( the_relationship );
                    {
                        ...
                        gui_sketch_card_private_draw_rect( this_, &segment_src, cr );
                    }
                    {
                        ...
                        gui_sketch_card_private_draw_rect( this_, &segment_dst, cr );
                    }
                    {
                        ...
                        gui_sketch_card_private_draw_rect( this_, &segment_main, cr );
                    }
                }
                break;
            }
                                 ...
                                 cairo_t *cr )
{
    ...
    if ( (*this_).visible )
    {
        ...
        if ( layout_visible_set_is_valid( layout ) && create_tool )
        {
            ...
            gui_sketch_card_private_draw_element_space( this_, &subelement_to_highlight, cr );
        }
    }
