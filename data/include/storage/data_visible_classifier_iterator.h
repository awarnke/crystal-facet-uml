/* File: data_visible_classifier_iterator.h; Copyright and License: see below */

#ifndef DATA_VISIBLE_CLASSIFIER_ITERATOR_H
#define DATA_VISIBLE_CLASSIFIER_ITERATOR_H

/* public file for the doxygen documentation: */
/*!
 *  \file
 *  \brief Iterates over a visible_classifier set which is a statement result from the database
 */
...
/*!
 *  \brief all data attributes needed for the visible_classifier iterator functions
 *
 ...
 */
struct data_visible_classifier_iterator_struct {
...
typedef struct data_visible_classifier_iterator_struct data_visible_classifier_iterator_t;

/*!
 *  \brief predefined search statement to find visible_classifiers by diagram-id
 */
extern const char *const DATA_VISIBLE_CLASSIFIER_ITERATOR_SELECT_BY_DIAGRAM_ID;

/*!
 *  \brief initializes the data_visible_classifier_iterator_t struct to an empty set
 *
 *  \param this_ pointer to own object attributes
 */
void data_visible_classifier_iterator_init_empty ( data_visible_classifier_iterator_t *this_ );

/*!
 *  \brief re-initializes the data_visible_classifier_iterator_t struct to iterate over a db-result-set of classifiers
 *
 *  \param this_ pointer to own object attributes
 ...
 *
 *  \param this_ pointer to own object attributes
 *  \return true if another visible_classifier exists, false if not or in case of an error
 */
bool data_visible_classifier_iterator_has_next ( const data_visible_classifier_iterator_t *this_ );

/*!
 *  \brief reads the next visible_classifier from the database (and internally advances to the visible_classifier after).
 *
 *  \param this_ pointer to own object attributes
 *  \param out_visible_classifier the next visible_classifier read from the database (in case of success)
...
#endif  /* DATA_VISIBLE_CLASSIFIER_ITERATOR_H */
