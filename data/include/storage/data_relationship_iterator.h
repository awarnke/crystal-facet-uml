/* File: data_relationship_iterator.h; Copyright and License: see below */

#ifndef DATA_RELATIONSHIP_ITERATOR_H
#define DATA_RELATIONSHIP_ITERATOR_H

/* public file for the doxygen documentation: */
/*!
 *  \file
 *  \brief Iterates over a relationship set which is a statement result from the database
 */
...
/*!
 *  \brief all data attributes needed for the relationship iterator functions
 *
 ...
 */
struct data_relationship_iterator_struct {
...
typedef struct data_relationship_iterator_struct data_relationship_iterator_t;
 ...
 *
 *  \param this_ pointer to own object attributes
 *  \return true if another relationship exists, false if not or in case of an error
 */
bool data_relationship_iterator_has_next ( const data_relationship_iterator_t *this_ );

/*!
 *  \brief reads the next relationship from the database (and internally advances to the relationship after).
 *
 *  \param this_ pointer to own object attributes
 *  \param out_relationship the next relationship read from the database (in case of success)
...
#endif  /* DATA_RELATIONSHIP_ITERATOR_H */
